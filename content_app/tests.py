...
class ContentTestCase(APITestCase):
    def setUp(self):
        ...
        self.content = models.Content.objects.create(
...
class ReviewTestCase(APITestCase):
    def setUp(self):
        ...
        self.content2 = models.Content.objects.create(
            platform=self.stream,
            title="Example Movie",
            storyline="Example Movie",
            active=True,
    ...
    def test_review_create(self):
        ...
        response = self.client.post(
            reverse("review-create", args=(self.content.id,)), data
        )
    ...
    def test_review_user(self):
        response = self.client.get(
            "/api/watchmate/user-reviews/?username=" + self.user.username
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
